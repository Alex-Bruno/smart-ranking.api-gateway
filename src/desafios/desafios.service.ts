...
export class DesafiosService {
    ...
    async atualizarDesafio(atualizarDesafioDto: AtualizarDesafioDto, _id: string) {
    ...
    async atribuirDesafioPartida(atribuirDesafioPartidaDto: AtribuirDesafioPartidaDto, _id: string) {
        const desafio: Desafio = await lastValueFrom(this.clientDesafios.send('consultar-desafios', { idJogador: '', _id: _id }));
